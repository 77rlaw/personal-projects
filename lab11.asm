...
; R5 - current sum
            ...
            .ORIG  x3000
      	    LD    R5, ZERO            ; Load ZERO into R5
	    LD    R3, ZERO            ; Load ZERO into R3
            LD    R0, ZERO            ; Load ZERO into R0
            LDI   R1, INPUT           ; Load INPUT into R1 using label
            LD    R2,MINUSONE           ; Load -1 into R2 from below
...
INPUT      .FILL  x5000
RESULT     .FILL  x30FF
.END                ; At program completion, the result is stored here
